...
// 現行プリセット（シンセ本領寄り：減算合成が気持ちよく鳴る音色）。
export const PRESETS: Preset[] = [
  {
    ...
    osc2Oct: 0,
    filterType: 'lowpass',
    env: { attack: 0.006, decay: 0.24, sustain: 0.78, release: 0.22 },
    cutoff: 0.52,
    res: 6.8,
    lfoRate: 5.8,
    lfoDepth: 0.55,
  ...
  },
  {
    ...
    osc2Oct: -1,
    filterType: 'lowpass',
    env: { attack: 0.014, decay: 0.82, sustain: 0.48, release: 0.15 },
    cutoff: 0.23,
    res: 2.2,
    lfoRate: 2.1,
    lfoDepth: 0,
  ...
  },
  {
    ...
    osc2Oct: 1,
    filterType: 'lowpass',
    env: { attack: 0.004, decay: 0.26, sustain: 0.02, release: 0.14 },
    cutoff: 0.38,
    res: 3.9,
    lfoRate: 4.2,
    lfoDepth: 0,
  ...
  },
  {
    ...
    osc2Oct: 0,
    filterType: 'lowpass',
    env: { attack: 1.1, decay: 0.75, sustain: 0.88, release: 2.2 },
    cutoff: 0.36,
    res: 1.8,
    lfoRate: 0.75,
    lfoDepth: 2.2,
    ...
    reverbMixAmt: 7.4,
    filterEnvAttack: 5.8,
    filterEnvSustain: 6.8,
    filterEnvRelease: 6.5,
    pulseWidth: 0.32,
  },
  {
    name: 'スタブ',
    ...
    osc2Oct: 0,
    filterType: 'lowpass',
    env: { attack: 0.006, decay: 0.28, sustain: 0.38, release: 0.12 },
    cutoff: 0.3,
    res: 4.8,
    lfoRate: 5,
    lfoDepth: 0.1,
  ...
  },
  {
    ...
    osc2Oct: 1,
    filterType: 'highpass',
    env: { attack: 0.002, decay: 0.16, sustain: 0.12, release: 0.05 },
    cutoff: 0.16,
    res: 1.2,
    lfoRate: 7.8,
    lfoDepth: 0,
